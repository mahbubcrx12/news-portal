...
import 'package:news_portal/service/news_details.dart';
import 'package:news_portal/widget/error_screen.dart';
              ...
              children: [
                ...
                Container(
                    ...
                    child: DropdownButton(
                      value: sortBy,
                        items: [
                          DropdownMenuItem(child: Text("${SortNews.popularity.name}"),
                          value: SortNews.popularity.name,
                          ),
                          DropdownMenuItem(child: Text("${SortNews.publishedAt.name}"),
                            value: SortNews.publishedAt.name,
                          ),
                          DropdownMenuItem(child: Text("${SortNews.relevancy.name}"),
                                              ...
                                              children: [
                                                ...
                                                Row(
                                                  ...
                                                  children: [
                                                    ...
                                                    Text(
                                                      "${snapshot.data![index].publishedAt}",maxLines: 1,
                                                    ),
                                                  ],
                                                )
                                              ],
